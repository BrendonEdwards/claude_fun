      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-300 text-sm mt-1">
            Unlimited expenses, invoices, and <strong className="text-white">CSV exports ready for your accountant or HMRC bridging software</strong>. Just £2.50/month. Cancel any time.
          </p>
        </div>
