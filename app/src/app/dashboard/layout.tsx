      ...
      <div className="max-w-7xl mx-auto flex">
        ...
        <nav className="w-60 min-h-[calc(100vh-57px)] bg-white border-r border-gray-100 p-4 hidden md:block flex flex-col">
          ...
          <div className="border-t border-gray-100 mt-4 pt-4">
            <p className="px-3.5 text-[10px] font-bold text-indigo-400 uppercase tracking-wider mb-2">Pro</p>
            {[
              { href: "/dashboard/hmrc-connect", label: "HMRC Connect", icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244" /></svg> },
              { href: "/dashboard/hmrc-submit", label: "Submit to HMRC", icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5" /></svg> },
              { href: "/dashboard/hmrc-obligations", label: "Obligations", icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" /></svg> },
            ].map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${
                    isActive
                      ? "bg-gradient-to-r from-indigo-500/10 to-indigo-500/5 text-indigo-500 border border-indigo-500/15"
                      : "text-muted hover:bg-surface hover:text-primary"
                  }`}
                >
                  <span className={isActive ? "text-indigo-500" : "text-muted"}>{item.icon}</span>
                  {item.label}
                </Link>
              );
            })}
