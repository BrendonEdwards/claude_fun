  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <div className="max-w-7xl mx-auto flex">
        {/* Sidebar */}
        <nav className="w-60 min-h-[calc(100vh-57px)] bg-white border-r border-gray-100 p-4 hidden md:block">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${
                    isActive
                      ? "bg-gradient-to-r from-accent/10 to-violet/5 text-accent border border-accent/15"
