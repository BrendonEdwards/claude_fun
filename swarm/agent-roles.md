...
- Focus on channels the Orchestrator can execute from a terminal
  (SEO, directory listings, forum posts, email, programmatic ads).
...
- Cold email ONLY to Ltd companies (PECR exemption for corporate subscribers).
- Every email sequence needs: subject line A/B variants, 3-email cadence,
  unsubscribe link, sender identification.
...
- For outreach: verify GDPR (data basis), PECR (electronic comms),
  and CAN-SPAM (if targeting any US audience) compliance.
- Distinguish between Ltd companies (corporate subscribers, PECR-exempt)
  and sole traders (individual subscribers, consent required).
